...
class UsageCostComponent extends Component {
	constructor(props) {
		super(props);
	...
	getGraphType = () => {
		if (this.state.display === 'daily') return <DailyWastageComponent />;
		else if (this.state.display === 'monthly') return <MonthlyWastageComponent />;
		else if (this.state.display === 'seasonal') return <SeasonalWastageComponent />;
...
export default UsageCostComponent;
