...
export const FETCH_SEGMENT_EVENTS_BEGIN = "FETCH_SEGMENTS_LEAKS_BEGIN";
export const FETCH_SEGMENT_EVENTS_SUCCESS = "FETCH_SEGMENTS_LEAKS_SUCCESS";
export const FETCH_SEGMENT_EVENTS_FAILURE = "FETCH_SEGMENTS_LEAKS_FAILURE";
