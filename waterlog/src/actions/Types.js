...
export const FETCH_LEAK_HISTORY_BEGIN = "FETCH_LEAK_LITRES_BEGIN";
export const FETCH_LEAK_HISTORY_SUCCESS = "FETCH_SEGMENTS_LEAKS_SUCCESS";
export const FETCH_LEAK_HISTORY_FAILURE = "FETCH_LEAK_LITRES_FAILURE";
